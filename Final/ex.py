...
textfile = ["input0.txt", "input1.txt", "input2.txt", "input3.txt", "input4.txt", "input5.txt"]   #modify the input file names if needed. Keep all these files in the same folder
